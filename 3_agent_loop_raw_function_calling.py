...
def apply_discount(price: float, discount_tier: str) -> float:
    ...
    discount_percentages = {"bronze": 5, "silver": 10, "gold": 15, "platinum": 20}
...
tools_for_llm = [
    ...
    },
    {
        ...
        "function": {
            "name": "apply_discount",
            "description": "Apply a discount tier to a price and return the final price. Available tiers: bronze, "
                           "silver, gold.",
            "parameters": {
                "type": "object",
                "properties": {
...
def run_agent(question: str):
    ...
    for iteration in range(1, MAX_ITERATIONS + 1):
        ...
        # appending the messages to have the history/contex/memory of past executions
